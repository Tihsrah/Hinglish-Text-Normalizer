...
for j in range(len(alpha)):
    ...
    dictionary = pd.read_csv(
        rf"C:\Users\harsh\Downloads\No Duplicates Dictionary\{alpha[j]}word_no_dupli.csv", engine="python", sep=',', quotechar='"', error_bad_lines=False, encoding="utf8")
    ...
    dictionary_translated.to_csv(
        rf'C:\Users\harsh\OneDrive - UPES\Desktop\hinglish to english\Oxford Dictionary Translated\{alpha[j]}word_translated.csv', index=False)
